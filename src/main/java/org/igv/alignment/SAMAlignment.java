...
import org.igv.feature.genome.HGVS;
...
import org.igv.ultima.FlowUtil;
import org.igv.ultima.annotate.FlowBlockAnnotator;
...
public class SAMAlignment implements Alignment {
    ...
    @Override
    public String getAlignmentValueString(double position, int mouseX, RenderOptions renderOptions) {
